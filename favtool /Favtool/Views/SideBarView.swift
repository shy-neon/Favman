...
struct SideBarView: View {
            ...
            .toolbar{
                        ...
                        Menu(content: {
                            if(selection != nil){
                                Button("Glass, Small", action: {
                                     setTransparency(site: selection!, value: 0)
                                 })
                                 Button("Transparent, Big", action: {
                                     setTransparency(site: selection!, value: 1)
                                 })
                                 Button("Glass, Big", action: {
                                     setTransparency(site: selection!, value: 3)
                                 })
                            }
                        }, label: {Text({
                            if(selection == nil){
                            ...
                            return transparencyString(value: selection!.transparencyResult)
                        }())
                        })
                     }
                ...
                ToolbarItem(placement: .navigation) {
                    Button(action:{
                        ...
                        Image(systemName: "sidebar.left")}).padding(1)
                }
                ...
                ToolbarItem(placement: .navigation) {
                    Button(action:{
                        ...
                        Image(systemName: "trash")}).padding(1)
                }
    ...
    func openReadme() {
        let url = URL(string: "https://github.com/shy-neon/favtool/blob/main/guide.md")!
