...
do
    case $opt in
        ...
        "Change an icon")
            ...
            echo -e "# The MD5 name will be calculated based on the string: ${color3}$domain${NC}"
            md5=$(md5 -q -s $domain)
        ...
        "Restore default icons")
            clear -x
            mainView
			echo "* If Safari have not downloaded icons correctly or if you want "
			echo "  to restore the original icons, type yes and run this."
		    echo "  However, all of your personal icons are going to be erased."
